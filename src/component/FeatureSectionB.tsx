import featureImageB from "../assets/images/featureImageB.png";
const FeatureSectionB = () => {
  return (
    <div className="flex flex-col md:flex-row-reverse md:w-[80%] w-full mx-auto justify-between items-center">
      ...
      <div className="rounded-full overflow-hidden aspect-square w-150">
        <img
          src={featureImageB}
          alt="feature image A"
...
export default FeatureSectionB;
